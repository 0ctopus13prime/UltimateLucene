...
class ArrayUtil {
 ...
 public:
  ...
  template <typename T>
  static T* CopyOf(const T* original, const uint32_t original_length) {
   ...
   **/
  template <typename T>
  static T* CopyOfRange(const T* original, const uint32_t from, const uint32_t to) {
    if (from >= to) {
  ...
  static INTEGER1 CheckFromToIndex(const INTEGER1 from_index,
  ...
  template <typename INTEGER1, typename INTEGER2, typename INTEGER3>
  static INTEGER1 CheckFromIndexSize(const INTEGER1 from_index,
                              const INTEGER2 size,
                              const INTEGER3 length) {
  ...
  static INTEGER1 CheckIndex(const INTEGER1 index, const INTEGER2 length) {
